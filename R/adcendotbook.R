...
adcendobook <- function(fig_width = 9,
                       fig_height = 6,
                       fig_caption = TRUE,
                       highlight = "kate",
                       code_folding = "hide",
    ...
    html_template(
        template_name = "adcendobook",
        template_path = "templates/template.html",
        template_dependencies = list(
            html_dependency_adcendobook(embed_fonts)
        ),
...
html_dependency_adcendobook <- function(embed_fonts = TRUE) {
  ...
  htmltools::htmlDependency(name = "adcendobook",
                 version = "0.1",
                 src = system.file("templates/adcendobook", package = "rmdadcendo"),
                 script = "robobook.js",
